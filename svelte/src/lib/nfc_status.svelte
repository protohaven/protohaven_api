<script type="typescript" lang="ts">
	...
	$: nfc_alive =
		nfc_heartbeat_age_sec !== null && nfc_heartbeat_age_sec <= NFC_HEARTBEAT_TIMEOUT_SEC;
...
<div class="nfc-indicator" id="nfc-indicator" class:online={all_ok} class:offline={!all_ok}>
