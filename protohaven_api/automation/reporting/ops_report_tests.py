...
class TestOpsItem:
    """Test OpsItem dataclass functionality"""
    
    def test_opsitem_initialization(self):
        """Test OpsItem can be initialized with various fields"""
        item = ops_report.OpsItem(
            category="Test",
            label="Test Item",
            source="Test Source",
            url="https://test.com",
    ...
    def test_opsitem_with_error(self):
        """Test OpsItem can handle errors"""
        error = RuntimeError("Test error")
        item = ops_report.OpsItem(label="Test", error=error)
        
        assert item.error == error


class TestOpsitemDecorator:
    """Test the opsitem decorator functionality"""
    
    def test_opsitem_decorator_applies_defaults(self):
    ...
    def test_opsitem_decorator_preserves_overrides(self):
...
class TestAsanaIntegrations:
    """Test Asana-based ops report functions"""
    
    def test_get_asana_assets_success(self):
    ...
    def test_get_asana_instructor_apps_success(self, mock_get_onhold):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.tasks.get_with_onhold_section')
    def test_get_asana_instructor_apps_error(self, mock_get_onhold):
    ...
    def test_get_asana_maint_tasks_success(self, mock_tznow, mock_get_tasks):
    ...
    def test_get_asana_proposals_success(self, mock_get_requests):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.tasks.get_with_onhold_section')
    def test_get_asana_tech_apps_success(self, mock_get_onhold):
    ...
    def test_get_asana_purchase_requests_success(self):
...
class TestSheetsIntegration:
    """Test Google Sheets-based ops report functions"""
    
    @patch('protohaven_api.automation.reporting.ops_report.tznow')
    def test_get_ops_manager_sheet_success(self, mock_tznow):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.tznow')
    def test_get_ops_manager_sheet_error(self, mock_tznow):
...
class TestAirtableIntegrations:
    """Test Airtable-based ops report functions"""
    
    @patch('protohaven_api.automation.reporting.ops_report.get_all_records')
    @patch('protohaven_api.automation.reporting.ops_report.tznow')
    def test_get_airtable_violations_success(self, mock_tznow, mock_get_records):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.get_all_records')
    def test_get_airtable_tool_info_success(self, mock_get_records):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.get_all_records')
    def test_get_airtable_instructor_capabilities_success(self, mock_get_records):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.get_all_records')
    @patch('protohaven_api.automation.reporting.ops_report.tznow')
    def test_get_airtable_class_proposals_success(self, mock_tznow, mock_get_records):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.get_all_records')
    @patch('protohaven_api.automation.reporting.ops_report.tznow')
    def test_get_shift_schedule_success(self, mock_tznow, mock_get_records):
...
class TestNeonIntegration:
    """Test Neon CRM-based ops report functions"""
    
    @patch('protohaven_api.automation.reporting.ops_report.neon.search_members_with_role')
    @patch('protohaven_api.automation.reporting.ops_report.tznow')
    def test_get_neon_tech_instructor_onboarding_success(self, mock_tznow, mock_search_role):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.neon.search_members_with_role')
    def test_get_neon_tech_instructor_onboarding_error(self, mock_search_role):
...
class TestWikiIntegration:
    """Test Wiki-based ops report functions"""
    ...
    def test_get_wiki_docs_status_success(self, mock_tool_docs, mock_class_docs):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.wiki.get_tool_docs_summary')
    def test_get_wiki_docs_status_error(self, mock_tool_docs):
...
class TestRunFunction:
    ...
    def test_run_concurrent_execution(self, mock_assets, mock_wiki):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.get_asana_assets')
    def test_run_error_truncation(self, mock_assets):
    ...
    @patch('protohaven_api.automation.reporting.ops_report.get_asana_assets')
    def test_run_string_error_handling(self, mock_assets):
