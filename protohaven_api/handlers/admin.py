...
from protohaven_api.automations.maintenance import tasks as mtask
...
def get_maintenance_data():
    ...
    airtable_id = airtable.get_tool_id(tc)
    ...
    return {
        ...
        "active_tasks": list(mtask.get_open_tasks_matching_tool(airtable_id)),
    }
