...
tech1 = MagicMock(emails=["a@a.com"], discord_user="foobar")
tech1.name = "Tech A"
tech2 = MagicMock(emails=["b@b.com"], discord_user=None)
tech2.name = "Tech B"
...
TESTED_TEMPLATES = [
    ...
    (
        "empty_shift_leads",
        {
            "shift": {"date": "2025-01-08", "shift": "AM", "days_away": 7},
        },
    ),
    (
        "empty_shift_techs",
        {
            "shift": {"date": "2025-01-01", "shift": "AM", "days_away": 0},
        },
    ),
    (
        "empty_shift_staff",
        {
            "shift": {"date": "2025-07-04", "shift": "AM", "days_away": 0},
        },
    ),
    (
...
HASHES = {
    ...
    "empty_shift_leads": "0a1a68b09e0b1f1e",  # pragma: allowlist secret
    "empty_shift_techs": "af9669dd35b9f4b5",  # pragma: allowlist secret
    "empty_shift_staff": "38e77d33ea640eb2",  # pragma: allowlist secret
    ...
    "sheets_backup_summary": "163779403ffea117",  # pragma: allowlist secret
